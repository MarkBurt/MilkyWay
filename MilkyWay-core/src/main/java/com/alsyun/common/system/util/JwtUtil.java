package com.alsyun.common.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws MilkyWayException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws MilkyWayException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new MilkyWayException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key, SysUserCacheInfo user) {
		if(user==null) {
			user = MilkyWayDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
