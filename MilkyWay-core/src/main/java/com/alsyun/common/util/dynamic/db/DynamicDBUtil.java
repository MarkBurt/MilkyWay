package com.alsyun.common.util.dynamic.db;
...
import com.alsyun.common.exception.MilkyWayException;
import com.alsyun.common.system.vo.DynamicDataSourceModel;
import com.alsyun.common.util.ReflectHelper;
    ...
    public static DruidDataSource getDbSourceByDbKey(final String dbKey) {
        ...
        if (cacheDbSource != null && !cacheDbSource.isClosed()) {
            ...
            if(dataSource!=null && dataSource.isEnable()){
                ...
                throw new MilkyWayException("动态数据源连接失败，dbKey："+dbKey);
            }
