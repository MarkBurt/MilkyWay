package com.alsyun.config.shiro;
...
import com.alsyun.config.shiro.filters.CustomShiroFilterFactoryBean;
import com.alsyun.config.shiro.filters.JwtFilter;
...
public class ShiroConfig {
    ...
    @Value("${MilkyWay.shiro.excludeUrls}")
