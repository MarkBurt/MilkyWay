package com.alsyun.common.modules.redis.writer;
 ...
 */
@Slf4j
public class MilkyWayRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public MilkyWayRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public MilkyWayRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
