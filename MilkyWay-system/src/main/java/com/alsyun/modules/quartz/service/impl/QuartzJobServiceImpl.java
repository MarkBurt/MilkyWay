package com.alsyun.modules.quartz.service.impl;
...
import com.alsyun.modules.quartz.entity.QuartzJob;
import com.alsyun.modules.quartz.mapper.QuartzJobMapper;
import com.alsyun.modules.quartz.service.IQuartzJobService;
import org.quartz.*;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	 ...
	 */
	@Override
	@Transactional(rollbackFor = MilkyWayException.class)
	...
	private void schedulerAdd(String id, String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new MilkyWayException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new MilkyWayException(e.getMessage(), e);
		}catch (Exception e) {
			throw new MilkyWayException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String id) {
		try {
			...
			throw new MilkyWayException("删除定时任务失败");
		}
	}
