...
import com.alsyun.modules.system.entity.SysPermission;
import com.alsyun.modules.system.entity.SysPermissionDataRule;
import com.alsyun.modules.system.mapper.SysDepartPermissionMapper;
import com.alsyun.modules.system.mapper.SysDepartRolePermissionMapper;
import com.alsyun.modules.system.mapper.SysPermissionMapper;
import com.alsyun.modules.system.mapper.SysRolePermissionMapper;
import com.alsyun.modules.system.model.TreeModel;
import com.alsyun.modules.system.service.ISysPermissionDataRuleService;
import com.alsyun.modules.system.service.ISysPermissionService;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws MilkyWayException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new MilkyWayException("未找到菜单信息");
		}
	...
	public void deletePermissionLogical(String id) throws MilkyWayException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new MilkyWayException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws MilkyWayException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws MilkyWayException {
