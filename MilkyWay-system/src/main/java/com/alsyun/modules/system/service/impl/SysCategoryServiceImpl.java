...
import com.alsyun.common.constant.FillRuleConstant;
import com.alsyun.common.exception.MilkyWayException;
import com.alsyun.common.util.FillRuleUtil;
import com.alsyun.common.util.oConvertUtils;
import com.alsyun.modules.system.entity.SysCategory;
import com.alsyun.modules.system.mapper.SysCategoryMapper;
import com.alsyun.modules.system.model.TreeSelectModel;
import com.alsyun.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws MilkyWayException{
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new MilkyWayException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new MilkyWayException("该编码【"+pcode+"】存在多个，请核实!");
			}
