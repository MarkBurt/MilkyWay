...
import com.alsyun.common.api.dto.OnlineAuthDTO;
import com.alsyun.common.api.dto.message.*;
import com.alsyun.common.aspect.UrlMatchEnum;
import com.alsyun.common.constant.CacheConstant;
import com.alsyun.common.constant.CommonConstant;
import com.alsyun.common.constant.DataBaseConstant;
import com.alsyun.common.constant.WebsocketConst;
...
import com.alsyun.common.system.vo.*;
import com.alsyun.common.util.SysAnnmentTypeEnum;
import com.alsyun.common.util.YouBianCodeUtil;
import com.alsyun.common.util.oConvertUtils;
import com.alsyun.modules.message.entity.SysMessageTemplate;
import com.alsyun.modules.message.handle.impl.EmailSendMsgHandle;
import com.alsyun.modules.message.service.ISysMessageTemplateService;
import com.alsyun.modules.message.websocket.WebSocket;
import com.alsyun.modules.system.entity.*;
import com.alsyun.modules.system.mapper.*;
import com.alsyun.modules.system.service.*;
import com.alsyun.modules.system.util.SecurityUtil;
...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	public void sendTemplateAnnouncement(TemplateMessageDTO message) {
		...
		if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
			throw new MilkyWayException("消息模板不存在，模板编码："+templateCode);
		}
